...
\date{Version 2.1.2 --- 19 September 2026}
...
\begin{figure}[ht]
\centering\includegraphics[width=.92\linewidth]{dr25_selection_surface.png}
...
\begin{figure}[ht]
\centering\includegraphics[width=.96\linewidth]{dr25_observed_vs_intrinsic.png}
...
\begin{figure}[ht]
\centering\includegraphics[width=.86\linewidth]{composition_model_disagreement.png}
...
\begin{figure}[ht]
\centering\includegraphics[width=.9\linewidth]{hwo_precursor_atlas.png}
...
\begin{figure}[ht]
\centering\includegraphics[width=.88\linewidth]{expected_information_gain.png}
...
\begin{figure}[ht]
\centering\includegraphics[width=.9\linewidth]{falsification_and_robustness.png}
