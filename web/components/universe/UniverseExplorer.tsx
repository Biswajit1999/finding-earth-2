...
const PLOT_CITATION = `Jana, Biswajit (2026). Finding Earth 2.0: an evidence-labelled search across public astronomical archives (v2.1.2). https://github.com/Biswajit1999/finding-earth-2. Data: NASA Exoplanet Archive and Gaia DR3. Accessed ${new Date().toISOString().slice(0, 10)}.`;
